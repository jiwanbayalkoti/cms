        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="length" id="length" class="form-control" step="0.001" min="0" value="{{ old('length', $completed_work->length) }}" required oninput="calculateQuantity()">
                    @error('length')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="number" name="width" id="width" class="form-control" step="0.001" min="0" value="{{ old('width', $completed_work->width) }}" required oninput="calculateQuantity()">
                    @error('width')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="number" name="height" id="height" class="form-control" step="0.001" min="0" value="{{ old('height', $completed_work->height) }}" required oninput="calculateQuantity()">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="quantity" id="quantity" class="form-control" step="0.001" min="0" value="{{ old('quantity', $completed_work->quantity) }}" readonly>
