                ...
                <form action="{{ route('admin.suppliers.update', $supplier) }}" method="POST" id="supplierForm" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="account_holder_name" class="form-control" value="{{ old('account_holder_name', $supplier->account_holder_name) }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="branch_name" class="form-control" value="{{ old('branch_name', $supplier->branch_name) }}">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Branch Address</label>
                        <input type="text" name="branch_address" class="form-control" value="{{ old('branch_address', $supplier->branch_address) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Upload a new QR code image to replace the existing one (JPEG, PNG, JPG, GIF, SVG - Max: 2MB)</small>
                        <div id="qr-preview" class="mt-2" style="display: none;">
                            ...
                            <p class="text-muted small mt-1">New QR Code Preview</p>
                        </div>
                    </div>
