...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.expenses.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition duration-200 flex items-center gap-2">
        <i class="bi bi-plus-circle"></i>
        <span class="mobile:hidden">Add New Expense</span>
