...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0">Create Sales Invoice</h1>
        <p class="text-muted mb-0">Record a sale to customer</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.sales-invoices.store') }}" method="POST" id="salesInvoiceForm">
            @csrf
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary">Create Sales Invoice</button>
            </div>
        </form>
    </div>
</div>
