        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            $response = [
                ...
                'material' => [
                    ...
                    'quantity_secondary' => $material->quantity_secondary,
                    'unit_secondary' => $material->unit_secondary,
                    'unit' => $material->unit,
        ...
        if (request()->ajax() || request()->wantsJson()) {
            return response()->json([
                'material' => [
                    ...
                    'size' => $construction_material->size,
                    'unit' => $construction_material->unit,
                    'quantity_secondary' => $construction_material->quantity_secondary,
                    'unit_secondary' => $construction_material->unit_secondary,
